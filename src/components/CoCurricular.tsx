// "use client";
// import { timeline } from "@/constants/cocurricular";
...
// export const CocurricularHistory = () => {
//   return (
//     <div>
...
export const CocurricularHistory = () => {
  const data = timeline.map((item, index) => (
    <ul key={index} className="list-disc w-full px-4">
      {item.responsibilities.map((responsibility, index) => (
  ...
  return <div className="w-full"><br></br>{data}</div>;
};
