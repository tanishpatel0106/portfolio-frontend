...
The most immediate problem comes from **amplified market impact**. When a PM sends an order, she already moves the price a bit by consuming liquidity. That’s unavoidable. But a few seconds later, the mirror book sends the same order again. It’s as if the PM is trading twice, even though she only wanted to trade once. The second trade pushes the price further in the same direction—raising costs if she’s buying, lowering proceeds if she’s selling. The PM ends up paying more or receiving less purely because the mirror book doubled the footprint of her activity.

Then there’s **the information problem**. Market makers and high-frequency trading firms are exceptionally good at detecting patterns in orderflow. If they notice that trades from this PM are consistently followed by another burst of volume a few seconds later, they start treating her initial trades as *informative*. Her flow looks predictive of future price pressure, even though that pressure isn’t informational—it's just the mirror book copying her.
...
Once liquidity providers perceive you as “informed,” everything gets more expensive. They widen spreads. They quote smaller sizes. They pull back when they see you coming. The PM begins to look like a bigger, more sophisticated trader than she actually is—and she pays the price for that illusion.
...
In short, mirroring is not neutral. It changes the PM’s environment, often in ways that reduce her performance even if her underlying alpha remains unchanged.
...
If a PM is sharp—and most are—she’ll eventually notice the pattern. Her trades get followed by a delayed echo. Sometimes the CIO mirrors a fixed percentage of her size. Sometimes the delay is nearly constant. Sometimes the execution style is straightforward enough that the pattern becomes predictable.
...
One common tactic is called “fading.” The PM places a small buy order—not because she truly wants the position yet, but because she knows the mirror book will follow shortly. When the mirror buy pushes the price up a bit more, the PM sells into the strength. The profit has nothing to do with fundamentals or alpha; it's extracted from the mechanical behavior of the mirror book itself.

Another tactic is **oversizing starter trades**. If a PM knows the CIO will mirror half her size, she can buy slightly more than she needs, let the mirror book push the price further up, and then sell back down to her desired holding. She captures the price impact the mirror book creates—impact she didn’t have to pay for.

More sophisticated PMs might experiment with **probe trades**—tiny trades designed to learn the mirror book’s exact timing and aggressiveness. Once the PM knows the mirror’s “algorithm,” she can orchestrate trades to profit from the predictable second wave of liquidity.

And then there’s the more subtle form of exploitation: **letting the mirror book absorb slippage**. By adjusting her execution style—using iceberg orders, slower clips, or transient liquidity pockets—the PM can set up situations where the CIO’s mirrored trades collide with thin markets while she herself waits safely on the sidelines. She effectively shifts her own execution costs onto the mirror book.
...
In the most extreme cases, the PM may not even care about the underlying position. The mirror book becomes a *tradable pattern*, and she begins constructing trades designed to profit purely from the CIO’s mechanical shadowing.
...
- how liquidity providers react to her  
- how much slippage she incurs  
- and even the incentives she faces  
